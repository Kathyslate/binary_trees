...
/**
 * get_binary_tree_level - perform a function on a specific level of a binary tree
...
void get_binary_tree_level(const binary_tree_t *root_node, size_t level, void (*function)(int))
{
	if (root_node == NULL)
		return;
	if (level == 1)
